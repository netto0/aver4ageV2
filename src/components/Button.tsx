...
export default function Button({
  ...
  switch (color) {
    case "gray":
      btnClass =
        "text-gray-300 inline-flex items-center bg-color5 hover:bg-color5 focus:ring-2 focus:outline-none focus:ring-color5 font-medium rounded-lg text-sm px-5 py-2.5 text-center drop-shadow-sm";
      break;
    case "green":
      btnClass =
