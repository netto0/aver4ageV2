export default function Settings() {
  return (
    <div className="w-full h-full text-customOrange flex flex-col gap-3 justify-center items-center text-center">
      <h1 className="text-3xl">PÁGINA DE CONFIGURAÇÕES</h1>
      <svg
